...
def get_df_code(llm, question):
    prompt = PromptTemplate(
        ...
        You are an expert of Jordan Standardized Precipitation Index data which is loaded in a 
        DataFrame df with the following columns: 
            ...
            Latitude, 
            Longitude, 
            Time (string type, a date is presented as a string in the format YYYY-MM-DD), 
            SPI. 
